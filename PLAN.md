...
- [x] Reconstruct Cdb during every selective-refresh scale sample with all registrations active, prove exact registration identity and unchanged Gateway state, then complete the measured writes and materializations through the reconstructed object.
