...
async function assertPackedBrowserBundle(cwd) {
    ...
    assert(code.includes("src/queries.ts#listMessages"), "generated browser bundle lost the planned query ref");
    assert(code.includes("src/api.ts#postMessage"), "generated browser bundle lost the mutation ref");
    assert(
        code.includes("src/api.ts#replaceMessageAttachment"),
