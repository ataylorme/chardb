...
One clean-HEAD local `throughput` sample at `b3b1294` on Bun 1.2.22 and an Apple M4 Pro recorded 119.25 mutations/s, 28,032.26 logical row deliveries/s, 105.39 registrations/s, 207.50 writes/s, and 222.52 materializations/s. This single Miniflare sample is regression telemetry, not a benchmark baseline, capacity claim, or performance target. The repository still requires repeated runs on a declared platform before setting targets.
