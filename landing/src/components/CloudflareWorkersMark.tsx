export function CloudflareWorkersMark() {
    return (
        <svg viewBox="0 0 256 231" aria-hidden="true" focusable="false" className="h-[0.86em] w-auto shrink-0">
            <defs>
                <linearGradient id="workers-a" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
                    <stop offset="0%" stopColor="#eb6f07" />
                    <stop offset="100%" stopColor="#fab743" />
                </linearGradient>
                <linearGradient id="workers-b" x1="81%" x2="40.5%" y1="83.7%" y2="29.5%">
                    <stop offset="0%" stopColor="#d96504" />
                    <stop offset="100%" stopColor="#d96504" stopOpacity="0" />
                </linearGradient>
                <linearGradient id="workers-c" x1="42%" x2="84%" y1="8.7%" y2="79.9%">
                    <stop offset="0%" stopColor="#eb6f07" />
                    <stop offset="100%" stopColor="#eb720a" stopOpacity="0" />
                </linearGradient>
                <linearGradient id="workers-d" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
                    <stop offset="0%" stopColor="#ee6f05" />
                    <stop offset="100%" stopColor="#fab743" />
                </linearGradient>
                <linearGradient id="workers-e" x1="-33.2%" x2="91.7%" y1="100%" y2="0%">
                    <stop offset="0%" stopColor="#d96504" stopOpacity="0.8" />
                    <stop offset="49.8%" stopColor="#d96504" stopOpacity="0.2" />
                    <stop offset="100%" stopColor="#d96504" stopOpacity="0" />
                </linearGradient>
                <linearGradient id="workers-f" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
                    <stop offset="0%" stopColor="#ffa95f" />
                    <stop offset="100%" stopColor="#ffebc8" />
                </linearGradient>
                <linearGradient id="workers-g" x1="8.1%" x2="96.5%" y1="1.1%" y2="48.8%">
                    <stop offset="0%" stopColor="#fff" stopOpacity="0.5" />
                    <stop offset="100%" stopColor="#fff" stopOpacity="0.1" />
                </linearGradient>
                <linearGradient id="workers-h" x1="-13.7%" x2="100%" y1="104.2%" y2="46.2%">
                    <stop offset="0%" stopColor="#fff" stopOpacity="0.5" />
                    <stop offset="100%" stopColor="#fff" stopOpacity="0.1" />
                </linearGradient>
            </defs>
