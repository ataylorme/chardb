...
describe("chardb init + doctor end-to-end", () => {
    test("init writes wrangler.toml + scaffolding; doctor passes", async () => {
        ...
        expect(files.get("/tmp/proj/src/api.ts")).toContain('ref: "src/api.ts#replaceMessageAttachment"');
        ...
        expect(files.get("/tmp/proj/src/queries.ts")).toContain('ref: "src/queries.ts#listMessages"');
