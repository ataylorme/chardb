...
The remaining resource work includes Cdb durable-byte bounds and total subscription-tombstone retention, presence state, other queues, slow-consumer backpressure, and retention watermarks.
